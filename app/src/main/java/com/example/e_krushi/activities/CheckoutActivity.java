...
import com.example.e_krushi.databinding.ActivityCheckoutBinding;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CartAdapter(this, products, new CartAdapter.CartListener() {
            ...
            public void onQuantityChanged() {
                ...
                double subtotalStr = getIntent().getDoubleExtra("subtotal", 0.0);

                double subtotal = subtotalStr;
        ...
        totalPrice = (subtotal * tax / 100) + subtotal;
    ...
    void processOrder() {
        ...
        try {
            ...
            productOrder.put("user_id", userID);
