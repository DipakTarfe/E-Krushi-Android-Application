...
import com.example.e_krushi.activities.CartActivity;
import com.example.e_krushi.databinding.ItemCartBinding;
import com.example.e_krushi.databinding.ItemCategoriesBinding;
import com.example.e_krushi.databinding.QuantityDialogBinding;
...
//                        cartListener.onQuantityChanged();
                ...
                quantityDialogBinding.deleteBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
                        cartListener.onDeleteClicked(product);
                        notifyDataSetChanged();
                    }
                });
                dialog.show();
